...
struct win_script {
	...
	/// Custom shader applied to the window while this animation is running.
	/// Only supported by backends that can create shaders (GLX/EGL).
...
typedef struct options {
	...
	/// Array of all the shader specifications used by `animations`. This is a
	/// dynarr.
