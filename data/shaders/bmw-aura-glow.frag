...
// Original effect: resources/shaders/aura-glow.frag
...
const float uSaturation = 0.75;
const float uBlur = 15.0;
const vec2 uSeed = vec2(1234.0, 5678.0);
const float uEdgeSize = 0.75;
const float uEdgeHardness = 0.25;
