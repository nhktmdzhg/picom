...
// Original effect: resources/shaders/hexagon.frag
...
// ==== effect body ====
const bool uAdditiveBlending = true;
const vec2 uSeed = vec2(1234.0, 5678.0);
const float uScale = 3.0;
const float uLineWidth = 2.0;
const vec4 uGlowColor = vec4(0.078, 0.314, 1.0, 0.5);
const vec4 uLineColor = vec4(0.784, 1.0, 1.0, 0.5);
