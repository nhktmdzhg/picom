...
// Original effect: resources/shaders/wisps.frag
...
const vec3 uColor1 = vec3(1.0, 0.392, 0.784);
const vec3 uColor2 = vec3(0.392, 0.392, 1.0);
const vec3 uColor3 = vec3(0.392, 0.784, 1.0);
